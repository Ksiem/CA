...
<html>
  <head>
	...
	<script type="text/javascript" src="../jslib/main/main.js"></script>
	<script type="text/javascript" src="../jslib/main/constant.js"></script>
	<script type="text/javascript" src="../jslib/main/step-jquery-dc.js"></script>
  </head>
